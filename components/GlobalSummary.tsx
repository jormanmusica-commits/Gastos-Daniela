...
const GlobalSummary: React.FC<GlobalSummaryProps> = ({ totalIncome, totalExpenses, currency, onIncomeClick, onExpenseClick }) => {
    ...
    <div className="bg-white dark:bg-gray-900/50 dark:backdrop-blur-sm dark:border dark:border-gray-800 p-6 rounded-xl shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <button
          ...
          aria-label="Ver desglose global de ingresos"
        >
        ...
        <button
          ...
          aria-label="Ver desglose global de gastos"
        >
          <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
            GASTOS (TOTAL)
          </h3>
